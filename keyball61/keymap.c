...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_right_ball(
        ...
        _______, _______,   _______,      MS_BTN3, _______,     _______,                                     _______,  _______, MS_BTN3, _______, _______,   _______,
        _______, MOUSE_OFF, KC_ESC ,      MS_BTN2, MS_BTN1,     _______,                                     _______,  MS_BTN1, MS_BTN2, KC_ESC,  MOUSE_OFF, _______,
        _______, _______,   _______,      _______, SCRL_MO,     _______,        _______,            _______, _______,  SCRL_MO, _______, _______, _______,   _______,
