...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMPAD] = LAYOUT_right_ball(
        ...
        _______,     KC_ESC ,      C(S(KC_Z)),          KC_LEFT,  KC_RGHT, KC_TILDE,                                     KC_ASTR,             KC_7,    KC_8,    KC_9,    KC_QUOT,   KC_ESC ,
        _______,     C(KC_A),      KC_BSPC,             KC_MINS,  KC_PLUS, KC_DQUO,                                      KC_0,                KC_4,    KC_5,    KC_6,    KC_EQL,    _______,
        _______,     C(KC_Z),      C(KC_X),             C(KC_C),  C(KC_V), KC_COMM,     KC_GRV,        _______,          KC_DOT,              KC_1,    KC_2,    KC_3,    KC_SLSH,   _______,
        _______,     _______,      _______,             _______,  _______, _______,     _______,       _______,          _______,                                        _______,   _______
    ),

    [_FN] = LAYOUT_right_ball(
        KC_F12,      KC_F1,        KC_F2,               KC_F3,    KC_F4,   KC_F5,                                        KC_F6,               KC_F7,   KC_F8,   KC_F9,   KC_F10,    KC_F11,
        _______,     DF(_GAMING),  _______,             _______,  KC_PSCR, _______,                                      KC_F11,              KC_F7,   KC_F8,   KC_F9,   KC_F12,    _______,
        _______,     UG_TOGG,      UG_PREV,             UG_NEXT,  _______, _______,                                      KC_F10,              KC_F4,   KC_F5,   KC_F6,   _______,   _______,
        _______,     CPI_D1K,      CPI_D100,            CPI_I100, CPI_I1K, _______,     _______,       A(KC_F4),         _______,             KC_F1,   KC_F2,   KC_F3,   _______,   _______,
        _______,     _______,      _______,             _______,  _______, _______,     _______,       _______,          _______,                                        _______,   _______
    ),
    ...
    [_GAMING] = LAYOUT_right_ball(
        ...
        KC_LSFT,     KC_A,         KC_S,                KC_D,     KC_F,    KC_G,                                         KC_H,                KC_J,    KC_K,    KC_L,    KC_SCLN,   KC_RSFT,
        KC_LCTL,     KC_Z,         KC_X,                KC_C,     KC_V,    KC_B,        KC_RALT,       KC_LBRC,          KC_N,                KC_M,    KC_COMM, KC_DOT,  KC_SLSH,   KC_RCTL,
        KC_APP, DF(_QWERTY),       KC_DEL,              KC_ENT,   KC_LALT, KC_SPC,      MO(_GAME_NUM), KC_BSPC,          KC_ENT,                                         KC_BSLS,   KC_QUOT
    ),
