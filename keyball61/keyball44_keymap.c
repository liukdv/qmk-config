// Miryoku adapted to a virtual 44-key area on the Keyball61.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_right_ball(
        ...
        KC_TAB,  LALT_T(KC_A),       LCTL_T(KC_R),  LSFT_T(KC_S),  LGUI_T(KC_T),  KC_D,                                         KC_H,          RGUI_T(KC_N),  RSFT_T(KC_E),  RCTL_T(KC_I),  RALT_T(KC_O),        KC_ENT,
        KC_LSFT, LT(_BUTTON, KC_Z),  KC_X,          KC_C,          KC_V,          KC_B,          KC_NO,                KC_NO,    KC_K,          KC_M,          KC_COMM,       KC_DOT,         LT(_BUTTON, KC_SLSH), KC_RSFT,
        KC_NO,   KC_NO,              DF(_QWERTY),   MO(_NAV),      LT(_MEDIA, KC_ESC), KC_SPC, LT(_MOUSE, KC_TAB),              LT(_SYM, KC_ENT), LT(_NUM, KC_BSPC),       LT(_FUN, KC_DEL),                        KC_NO
    ),

    [_QWERTY] = LAYOUT_right_ball(
        KC_NO,   KC_NO,              KC_NO,         KC_NO,         KC_NO,         KC_NO,                                        KC_NO,         KC_NO,         KC_NO,         KC_NO,         KC_NO,               KC_NO,
        KC_ESC,  KC_Q,               KC_W,          KC_E,          KC_R,          KC_T,                                         KC_Y,          KC_U,          KC_I,          KC_O,          KC_P,                KC_BSPC,
        KC_TAB,  LALT_T(KC_A),       LCTL_T(KC_S),  LSFT_T(KC_D),  LGUI_T(KC_F),  KC_G,                                         KC_H,          RGUI_T(KC_J),  RSFT_T(KC_K),  RCTL_T(KC_L),  RALT_T(KC_QUOT),     KC_ENT,
        KC_LSFT, LT(_BUTTON, KC_Z),  KC_X,          KC_C,          KC_V,          KC_B,          KC_NO,                KC_NO,    KC_N,          KC_M,          KC_COMM,       KC_DOT,         LT(_BUTTON, KC_SLSH), KC_RSFT,
        KC_NO,   KC_NO,              DF(_COLEMAK),  MO(_NAV),      LT(_MEDIA, KC_ESC), KC_SPC, LT(_MOUSE, KC_TAB),              LT(_SYM, KC_ENT), LT(_NUM, KC_BSPC),       LT(_FUN, KC_DEL),                        KC_NO
    ),
