...
enum layer_number {
  _COLEMAK = 0,   
  _QWERTY,          // Base Colemak layer
  _EXTEND_QW,        // Dreymar-style Extend layer
  _EXTEND
};
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, DF(_QWERTY),KC_LBRC,KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                        KC_RALT, KC_DEL, KC_SPC, MO(_EXTEND),   KC_RGUI, KC_BSPC, KC_ENT, KC_LALT
),
...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, DF(_COLEMAK), KC_LBRC, KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,
                KC_RALT, KC_DEL, KC_SPC,        MO(_EXTEND_QW), KC_RGUI, KC_BSPC, KC_ENT, KC_LALT
...
[_EXTEND] = LAYOUT(
  ...
  KC_TAB,  KC_ESC, C(S(KC_Z)), KC_WBAK, KC_WFWD, KC_ENT,                  KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_DEL,  KC_PSCR,
  KC_LSFT,  KC_LALT, KC_LCTL, KC_LSFT, KC_LGUI, KC_TAB,                   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, KC_GRV,
  KC_LCTL,  C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_BSPC, _______, KC_RBRC,KC_MPRV, KC_VOLD, KC_MPLY, KC_VOLU, KC_MNXT, KC_BSLS,
                        KC_RALT, KC_DEL, KC_SPC,         _______, KC_RGUI,KC_BSPC, KC_ENT, KC_LALT
),
