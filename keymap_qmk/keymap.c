...
[_COLEMAK] = LAYOUT(
  ...
  MO(_EXTEND),KC_A, KC_R,    KC_S,    KC_T,    KC_G,                     KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, DF(_QWERTY),  KC_RBRC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                        KC_LCTL, KC_DEL, KC_BSPC, KC_SPC,  KC_ENT, KC_LALT, KC_LGUI, KC_RALT
),
...
[_QWERTY] = LAYOUT(
  ...
  MO(_EXTEND_QW),   KC_A,   KC_S,   KC_D,   KC_F,   KC_G,          KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,
...
[_EXTEND] = LAYOUT(
  ...
  _______,  KC_LALT, _______, KC_LSFT, KC_LCTL, _______,                   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, KC_TILD,
  KC_LSFT,  C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, KC_LBRC, _______, C(KC_LEFT), C(KC_DOWN), C(KC_UP), C(KC_RGHT), KC_RSFT,
                             KC_LCTL, KC_DEL, KC_BSPC, KC_SPC, KC_ENT, KC_LALT , KC_LGUI, KC_RALT
),
